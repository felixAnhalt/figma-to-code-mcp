...
* **get-figma-design-tool:** add resolveVariables option for variable resolution ([#17](https://github.com/felixAnhalt/figma-to-code-mcp/issues/17)) ([5a2451f](https://github.com/felixAnhalt/figma-to-code-mcp/commit/5a2451f625b8114a0e180fba66eae65dd39a871e))
...
- **all:** reduce tokens by alot ([#1](https://github.com/felixAnhalt/Figma-Context-MCP/issues/1)) ([a3d1137](https://github.com/felixAnhalt/Figma-Context-MCP/commit/a3d11377f8d37427cc38bae82bdd89bbe18fe1c4))
- **all:** remove demo section to streamline documentation ([4121518](https://github.com/felixAnhalt/Figma-Context-MCP/commit/4121518dfc836eaac7bc46c566f15b8873ef4f0c))
- Extracting global variables ([bb52df2](https://github.com/felixAnhalt/Figma-Context-MCP/commit/bb52df2835a7d34b588ab553e8807ff4c1a3d356))
- Extracting global variables ([03143b8](https://github.com/felixAnhalt/Figma-Context-MCP/commit/03143b834385176b474bed22660120dd36a86970))
- Include component and component set names to help LLMs find pre-existing components in code ([#122](https://github.com/felixAnhalt/Figma-Context-MCP/issues/122)) ([60c663e](https://github.com/felixAnhalt/Figma-Context-MCP/commit/60c663e6a83886b03eb2cde7c60433439e2cedd0))
- **security:** add input validation to download images tool ([#207](https://github.com/felixAnhalt/Figma-Context-MCP/issues/207)) ([651974e](https://github.com/felixAnhalt/Figma-Context-MCP/commit/651974e6f31a3b60b863dab12e69029c710dd1c0))
- **security:** add path sanitization to prevent directory traversal ([#206](https://github.com/felixAnhalt/Figma-Context-MCP/issues/206)) ([5a18eef](https://github.com/felixAnhalt/Figma-Context-MCP/commit/5a18eef889b0449894e835f71b15786e4e36dd10))

### Bug Fixes

- Cannot find module '~/transformers/layout' ([7432d6c](https://github.com/felixAnhalt/Figma-Context-MCP/commit/7432d6ca28796327aec9f4fdd4b2948b95b49a08))
- Cannot find module '~/transformers/layout' ([82a52f7](https://github.com/felixAnhalt/Figma-Context-MCP/commit/82a52f7e4b349268995633f229e03ee034cce8b5))
- enhance fetchWithRetry to handle error statuses in response body ([803a479](https://github.com/felixAnhalt/Figma-Context-MCP/commit/803a479c2a3f0e8b8636f498728b5aaca2e30580))
- Fix bug where MCP cannot be invoked by cursor 0.45.11 ([dbea364](https://github.com/felixAnhalt/Figma-Context-MCP/commit/dbea36451cbf68f6d1dd814fed01743a1fdd27f4))
- Make sure LLM provides a filename extension when calling download_figma_images ([00bad7d](https://github.com/felixAnhalt/Figma-Context-MCP/commit/00bad7dae48a6d0cc55d78560cc691a39271f151))
- README.zh-tw typo ([#236](https://github.com/felixAnhalt/Figma-Context-MCP/issues/236)) ([c65c25c](https://github.com/felixAnhalt/Figma-Context-MCP/commit/c65c25c16f19c7f05c05f976b26cc5fbd2bcb19a))
- Remove empty keys from simplified design output ([#106](https://github.com/felixAnhalt/Figma-Context-MCP/issues/106)) ([4237a53](https://github.com/felixAnhalt/Figma-Context-MCP/commit/4237a5363f696dcf7abe046940180b6861bdcf22))
- Replaced the NODE_ENV setting with cross-env to improve cross-platform compatibility. ([#19](https://github.com/felixAnhalt/Figma-Context-MCP/issues/19)) ([a0eeed5](https://github.com/felixAnhalt/Figma-Context-MCP/commit/a0eeed588002915df1489346880372a5896b3fdb))
- update Node ID regex to support additional formats in download i… ([#227](https://github.com/felixAnhalt/Figma-Context-MCP/issues/227)) ([68fbc87](https://github.com/felixAnhalt/Figma-Context-MCP/commit/68fbc87645d25c57252d4d9bec5f43ee4238b09f))
- upgrade MCP SDK to 1.27.1 and modernize tool registration ([#282](https://github.com/felixAnhalt/Figma-Context-MCP/issues/282)) ([4153e5f](https://github.com/felixAnhalt/Figma-Context-MCP/commit/4153e5f857aa708ee9ee10156e553c1289f03cf7))
- use Node 24 in release workflow for npm OIDC support ([11ba7c6](https://github.com/felixAnhalt/Figma-Context-MCP/commit/11ba7c6a2e22910c483592ba7cdc1966fcdc9166))
